		...
		$woo_slg_settings = array(
				...
				array(
					...
					'options'=> array(
						...
						'realemailbased'	=> __( 'Actual email ID ( i.e. john.smith@example.com to john.smith@example.com )', 'wooslg' ).'<br>'.__('<span class="woo-slg-warning-message">( <span class="woo-slg-not-rec">Not Recommended</span> : This may create compatibility issues with other third party plugins. )','wooslg')
					)
				),
				array(
