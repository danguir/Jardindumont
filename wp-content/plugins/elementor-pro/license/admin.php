...
class Admin {
	...
	public function action_activate_license() {
		...
		if ( API::STATUS_VALID !== $data['license'] ) {
			$errors = [
				...
				'item_name_mismatch' => sprintf( __( 'Your license has a name mismatch. Please go to <a href="%s" target="_blank">your purchases</a> and choose the proper key.', 'elementor-pro' ), 'https://anonym.to/?https://go.elementor.com/my-account/' ),
			];
		...
		<div class="wrap">
			...
			<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
				...
				<?php if ( empty( $license_key ) ) : ?>
					...
					<p class="description"><?php printf( __( 'Please enter your license key. You can find your key in <a href="%s" target="_blank">your purchases</a>. License key looks similar to this: fb351f05958872E193feb37a505a84be', 'elementor-pro' ), 'https://anonym.to/?https://go.elementor.com/my-account/' ); ?></p>
				...
				<?php else :
					...
					<?php if ( API::STATUS_EXPIRED === $license_data['license'] ) : ?>
						<p><?php _e( '<strong>Your license has expired!</strong> Please <a href="https://anonym.to/?https://my.elementor.com/purchases/" target="_blank">renew it or purchase a new one</a> in order to get updates.', 'elementor-pro' ); ?></p>
				<?php endif; ?>
	...
	public function admin_license_details() {
		...
		$errors = [
			...
			API::STATUS_INVALID => sprintf( __( 'Something went wrong with license key is activated on your site. Please go to <a href="%s">your account in Elementor</a> to get an updated license key.', 'elementor-pro' ), 'https://anonym.to/?https://go.elementor.com/my-account/' ),
