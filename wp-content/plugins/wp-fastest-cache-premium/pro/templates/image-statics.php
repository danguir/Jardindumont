<?php
	...
	$wpfc_servers = array("de" => get_server_response_time("https://api.wpfastestcache.net"),
					 	  "us" => get_server_response_time("https://api.wpfastestcache.org"),
					 	  "la" => get_server_response_time("https://api.wpfastestcache.info"),
					 	  "uk" => get_server_response_time("https://api.wpfastestcache.co.uk"),
		...
		<div id="wpfc-statics-right" style="float: left;padding-left:12px;">
			...
			<ul style="list-style: none outside none;float: left;">
				...
				<li style="display:none;">
					...
					<div style="width: 70px;float:left;">
						<input <?php if($wpfc_server_location == "us"){echo "checked"; }?> value="us" name="wpfc-server-location" type="radio" style="vertical-align: top; padding-top: 0px; margin-top: 0px;"><img src="<?php echo plugins_url("wp-fastest-cache-premium/pro/images/US.jpg"); ?>">
						<div style="color:black;float: right; width: 62px; text-align: center;font-weight:bold;">Chicago</div>
						<div style="color:<?php echo $wpfc_servers["us"]["color"]; ?>;float: right; width: 62px; text-align: center;font-weight:bold;"><?php echo $wpfc_servers["us"]["time"]; ?></div>
					</div>
					<div style="width: 70px;float:left;">
