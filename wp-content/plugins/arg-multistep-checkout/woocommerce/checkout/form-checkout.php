...
?>
<div data-scrolltopdesktops="<?php echo $options['scrollTopDesktops']; ?>" data-scrolltopmobiles="<?php echo $options['scrollTopMobiles']; ?>" class="argmc-wrapper wrapper-no-bkg <?php echo $class; ?>" data-coupon-position="<?php echo $showCoupon === false ? $options['coupon_position'] : 'default'; ?>">
	<?php
